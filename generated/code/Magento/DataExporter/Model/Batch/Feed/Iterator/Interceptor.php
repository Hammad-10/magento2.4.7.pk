...
class Interceptor extends \Magento\DataExporter\Model\Batch\Feed\Iterator implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\DataExporter\Model\Batch\BatchLocator $batchLocator, \Magento\DataExporter\Model\Batch\BatchTable $batchTable, string $sourceTableName, array $sourceTableKeyColumns, \Magento\DataExporter\Model\Logging\CommerceDataExportLoggerInterface $logger, ?string $dateTimeFormat = null, ?bool $isRemovable = null)
    {
        $this->___init();
        parent::__construct($resourceConnection, $batchLocator, $batchTable, $sourceTableName, $sourceTableKeyColumns, $logger, $dateTimeFormat, $isRemovable);
    }
